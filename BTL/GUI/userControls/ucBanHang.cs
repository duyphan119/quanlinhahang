...
namespace BTL
{
    public partial class ucBanHang : UserControl
    {
        ...
        public void activeTable(ucBan uc, Ban ban)
        {
            if (btn_table != null)
            {
                btn_table.cancelActive();
            }
            uc.active();
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageDialog.Show("Chưa chọn bàn", "Lỗi", MessageDialogButtons.OK, MessageDialogIcon.Error, MessageDialogStyle.Light);
            }
            else
            {
                //Tiến hành thêm món
        ...
        private void btnChangeTable_Click(object sender, EventArgs e)
        {
            if (cbNewTable.SelectedItem != null)
            {
                ...
                if (answer == DialogResult.Yes)
                {
                    ...
                    btn_table.order(true);
                    activeTable(btn_table, ban_dang_chon);
